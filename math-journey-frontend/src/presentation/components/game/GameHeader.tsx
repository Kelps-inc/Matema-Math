...
import { ChatWidget } from '@/presentation/components/game/ChatWidget'
import { PresenceHeartbeat } from '@/presentation/components/game/PresenceHeartbeat'
import { AmigosOnlineBadge } from '@/presentation/components/game/AmigosOnlineBadge'
      ...
      <div className="max-w-screen-2xl mx-auto px-3 h-14 flex items-center justify-between gap-1">
        ...
        <nav className="hidden sm:flex items-center gap-0.5">
          ...
          <Link href="/amigos" className="flex flex-col items-center justify-center gap-0.5 px-2.5 py-1.5 text-sm font-medium text-white/70 hover:text-white hover:bg-white/10 rounded-xl transition-colors">
            ...
            <span className="text-xs leading-none flex items-center gap-1">Amigos <AmigosOnlineBadge /></span>
          </Link>
